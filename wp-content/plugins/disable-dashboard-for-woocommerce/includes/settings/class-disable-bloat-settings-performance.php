...
function wcbloat_performance_settings_init()
{
    ...
    add_settings_field(
        ...
        esc_attr__( 'Password Strength Meter', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Comments scripts', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Auto-linking URLs in comments', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Disable Dashicons', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'DNS prefetch to s.w.org', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Disable jQuery Migrate', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'WordPress & WooCommerce Meta Generator Tag', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Emoji styles and scripts', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Disable wp-embed', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'RSS Feed Links', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'RSS feeds', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Feed Generator Tag', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Windows Live Writer', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'RSD Link', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Shortlink', 'disable-dashboard-for-woocommerce' ),
...
{
    echo  '<span class="dashicons dashicons-admin-site-alt"></span>' ;
}

// First section with title description
function wcbloat_site_performance_desc_callback()
{
    echo  '<p>' . __( 'Page load time is very important for your visitors. To improve page load time, try to disable scripts, features, and unnecessary queries:', 'disable-dashboard-for-woocommerce' ) . '</p><hr />' ;
}

// Speed up your site section
function wcbloat_performance_speed_section_callback()
{
    echo  '<p>' . __( 'Use the settings from this section to reduce page load time on the front-end of your WordPress site. Before disabling them, please make sure that you will not use any of these features - so they can be safely turned off.', 'disable-dashboard-for-woocommerce' ) . '</p>' ;
...
<tr>
	...
	<p><?php 
    echo  wcbloat_is_pro_badge() ;
    _e( 'WordPress by default comes with a lot of Dashboard widgets installed. They often are not used at all, but can add backend load and front-end load. Choose Dashboard Widgets you would like to disable for this site. The <strong>ones you choose will be disabled</strong>, and the <strong>ones that had not been selected will stay active</strong>.', 'disable-dashboard-for-woocommerce' );
    ?></p>
