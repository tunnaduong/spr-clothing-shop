...
function wcbloat_block_settings_init()
{
	...
	add_settings_field(
		...
		esc_attr__('Disable Gutenberg Widget Block Editor','disable-dashboard-for-woocommerce'),
		'wcbloat_disable_widget_block_editor_callback',
		'wcbloat-block',
		'wcbloat-gutenberg-features-section'
	);
	register_setting(
	...
	add_settings_field(
		...
		esc_attr__('Welcome Guide', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('WordPress Block Directory', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Remove the default block patterns', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Auto-exit the Fullscreen Mode on editor load', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Deactivate the Template Editor', 'disable-dashboard-for-woocommerce'),
...
// Disable Gutenberg Widget Block Editor
function wcbloat_disable_widget_block_editor_callback()
{
	$value = get_option('wcbloat_disable_widget_block_editor');
?>
	<input type='hidden' name='wcbloat_disable_widget_block_editor' value='no'>
	<label><input type='checkbox' name='wcbloat_disable_widget_block_editor' <?php checked(esc_attr($value), 'yes'); ?> value='yes'> <?php esc_attr_e('Disable Gutenberg Widget Block Editor', 'disable-dashboard-for-woocommerce'); ?></label>
	<p><?php _e('Check this option to disable the new widget block editor page. By doing so, you\'ll restore the familiar "classic" WordPress widgets screen and deactivate the block editor\'s widget management functionality. This allows you to continue managing widgets in the traditional way, providing a more familiar and comfortable experience for users used to the classic widget interface.', 'disable-dashboard-for-woocommerce'); ?></p>
<?php
}
