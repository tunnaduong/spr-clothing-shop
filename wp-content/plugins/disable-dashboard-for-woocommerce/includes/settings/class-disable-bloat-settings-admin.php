...
function wcbloat_admin_settings_init()
{
    ...
    add_settings_field(
        ...
        esc_attr__( 'Hide update notice for non-admin users', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Disable Autosave', 'disable-dashboard-for-woocommerce' ),
        'wcbloat_autosave_disable_callback',
        'wcbloat-admin',
        'wcbloat_clean_admin_section'
    );
    register_setting( 'wcbloat-admin-options', 'wcbloat_autosave_disable', array(
        'sanitize_callback' => 'sanitize_key',
    ) );
    ...
    add_settings_field(
        ...
        esc_attr__( 'WordPress logo in the admin bar', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Admin footer text', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Hide WordPress logo on the Login Page', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Change the Logo Link', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Change the Logo title parameter', 'disable-dashboard-for-woocommerce' ),
    ...
    add_settings_field(
        ...
        esc_attr__( 'Disable WordPress Login Language Switcher', 'disable-dashboard-for-woocommerce' ),
...
{
    echo  '<p>' . __( 'By default, the WordPress admin panel is cluttered with preinstalled elements that may distract you from your work. You can simplify your WordPress admin panel by hiding or turning them off.', 'disable-dashboard-for-woocommerce' ) . '</p><hr />' ;
...
{
    echo  '<p>' . __( 'If you love a simple and flexible interface, use the options below to maximize your performance while browsing through the WordPress admin panel. By removing unnecessary elements, you will be 100% focused on your tasks.', 'disable-dashboard-for-woocommerce' ) . '</p>' ;
}
...
// Disable Autosave
function wcbloat_autosave_disable_callback()
{
    $value = get_option( 'wcbloat_autosave_disable' );
    ?>
	<input type='hidden' name='wcbloat_autosave_disable' value='no'>
	<label><input type='checkbox' name='wcbloat_autosave_disable' <?php 
    checked( esc_attr( $value ), 'yes' );
    ?> value='yes'> <?php 
    esc_attr_e( 'Disable WordPress editor Autosave feature', 'disable-dashboard-for-woocommerce' );
    ?></label>
	<p><?php 
    _e( 'WordPress saves everything you write on the editor after an interval of 60 seconds. It can use excessive server resources and may cause performance issues. Enabling this option will turn off the autosave feature.', 'disable-dashboard-for-woocommerce' );
    ?></p>
<?php 
}
...
// Hide standard WordPress Logo from Login Page PRO
